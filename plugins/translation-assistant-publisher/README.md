...
WordPress plugin that receives chapter translation exports from [Translation Assistant (ta-python)](https://github.com/Punllarena/ta-python) via REST API and publishes them as:
